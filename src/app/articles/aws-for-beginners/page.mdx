...
export const article = {
  author: 'Zakaria Slimane',
  date: '2024-12-13',
  title: 'AWS for beginners : Essential Services to know',
  description:
    'A beginner friendly guide to help beginners understand and start using AWS services effectively.',
}
