...
function Resume() {
  let resume = [
    ...
    {
      company: 'Nuitee Travel',
      title: 'Fullstack Developer',
      start: '2023',
      end: '2024',
    },
    {
      company: 'AD/HOC Agency',
      title: 'Fullstack Developer',
      start: '2022',
      end: '2023',
    },
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software developer, javascript, DevOps & Cloud.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Zakaria Slimane, a software developer and cloud enthusiast with
            an AWS Solutions Architect certification. <br /> I focus on
            JavaScript + React and DevOps practices to help teams deliver faster
            and more reliably. <br /> Beyond my projects, I enjoy writing about
            software, automation, and cloud technologies.
          </p>
